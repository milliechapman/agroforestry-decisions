...
## Background on our Grad Student Pursuit:
 ...
 + Agroforestry is a traditional land use practice that leverages agricultural lands as a natural climate solution (Griscom et al., 2017) and is an integral part of numerous countries’ Nationally Declared Contributions (NDCs) to climate mitigation and adaptation (IPCC, 2014). 
...
Agroforestry adoption literature largely focuses on individual decision making, 

![Three hypotheses for the spatial distributionn of agroforestry in relation to protected areas from Russel et al, 2010. Policy has been shown to be a driver of which of these patterns is predominate on the landscape.](images/background_1.png)
...
To understand how tree cover on agricultural lands in close proximity to protected areas varies from the larger lanscape.

We will conduct a policy analysis on relevant policies within the two nations pulling from existing policy meta-data. We aim to categories policies by {policy type, geographic region, issued by, date in effect, date out of effect*} *if applicable
...
(1) Create buffers on protected areas and summarize cropland areea and cropland tree cover within buffers and ouside of buffers for 3-4 countries

(2) Create an efficient workflow for reproducibly downloading and working with large spatial datasets
