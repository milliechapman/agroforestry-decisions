...
We also got this running in google earth engine, which will be a nice comparison for efficiency as we scale up the project! (see code here: https://code.earthengine.google.com/50a763dfb7868aaf0668a9cace73b1cb?noload=1)

(1) GEE analysis progress 
![gee](../images/gee.png)
