...
Plotting protected areas, for example:
...
We add a buffer around the protected area
...
#afr <-shp %>%
#  filter(PARENT_ISO=='BFA;NER;BEN')
#st_write(afr, 'usprotected/us_protected_areas.shp')
